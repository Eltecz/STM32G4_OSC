/*
 * @Description: 
 * @FilePath: \MDK-ARM\usr\delay.c
 * @Version: 2.0
 * @Autor: Eltecz
 * @Date: 2022-08-22 00:01:25
 * @LastEditors: Eltecz
 * @LastEditTime: 2022-09-06 10:39:44
 */
#include "delay.h"
...
//SYSTICK的时钟设置为内核时钟
//SYSCLK:系统时钟频率,即CPU频率(rcc_c_ck),180Mhz
...
{	 	 
	u16 repeat=nms/10;						//这里用30,是考虑到可能有超频应用,
