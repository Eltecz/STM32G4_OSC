...
/** @defgroup USBD_DESC_Private_FunctionPrototypes USBD_DESC_Private_FunctionPrototypes
  ...
  * @{
  */
uint8_t * USBD_Mult_DeviceDescriptor(USBD_SpeedTypeDef speed, uint16_t *length);
...
USBD_DescriptorsTypeDef Mult_Desc =
{
  USBD_Mult_DeviceDescriptor,
  USBD_CDC_LangIDStrDescriptor,
  USBD_CDC_ManufacturerStrDescriptor,
  USBD_CDC_ProductStrDescriptor,
  USBD_CDC_SerialStrDescriptor,
...
__ALIGN_BEGIN uint8_t USBD_Mult_DeviceDesc[USB_LEN_DEV_DESC] __ALIGN_END =
{
  0x12,                       /*bLength */
  USB_DESC_TYPE_DEVICE,       /*bDescriptorType*/
  0x00,                       /*bcdUSB */
...
{
  UNUSED(speed);
  *length = sizeof(USBD_Mult_DeviceDesc);
  return USBD_Mult_DeviceDesc;
}
